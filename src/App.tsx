        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-16">
          ...
          <div className="relative grid h-[30rem] w-full max-w-[21rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="relative p-6 px-6 py-14 md:px-12">
              ...
              <h5 className="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-400">Prema .S</h5>
              {/* <img alt="Tania Andrew" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1480&amp;q=80" className="relative inline-block h-[74px] w-[74px] !rounded-full border-2 border-white object-cover object-center" /> */}
            </div>
          </div>
          <div className="relative grid h-[30rem] w-full max-w-[21rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="relative p-6 px-6 py-14 md:px-12">
              <h2 className="mb-6 block font-sans text-2xl font-medium leading-[1.5] tracking-normal text-white antialiased">Head of Software Development</h2>
        ...
        <div className="bg-white  md:pt-32 md:py-32 pt-16 py-16">
          <div className="mx-auto  px-6 lg:px-8">
            ...
            <div className='flex justify-end font-bold md:hidden '>
              scroll &nbsp; &nbsp; <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className='mt-4 flex justify-center items-center'>
              ...
              <button
                ...
                type="submit"
                className={`animate-pulse w-1/4 text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:ring-4 focus:outline-none
